...
vss_uebung-Linux-DebugGame:
	 $(PROJECTBUILD) vss_uebung Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

vss_uebung-Linux-Shipping:
	 $(PROJECTBUILD) vss_uebung Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

vss_uebung:
	 $(PROJECTBUILD) vss_uebung Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

vss_uebungEditor-Linux-DebugGame:
	 $(PROJECTBUILD) vss_uebungEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

vss_uebungEditor-Linux-Shipping:
	 $(PROJECTBUILD) vss_uebungEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

vss_uebungEditor:
	 $(PROJECTBUILD) vss_uebungEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
